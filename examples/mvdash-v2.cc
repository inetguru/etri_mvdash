...
// ===========================================================================================
    ...
    double   simTime=100.0;             // Simulation Finish Time in seconds
    ...
    cmd.AddValue ("mvAlgo", "[maximize_current, newone]", mvAlgo);
    cmd.Parse (argc, argv);
...
static void bwevent_handler(Ptr<NetDevice> dev, uint64_t bps) {
