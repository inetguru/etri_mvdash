...
#ifndef REQUEST_SINGLE
#define REQUEST_SINGLE

#include "ns3/module_request.h"
namespace ns3 {
class requestSingle : public moduleRequest
{
public:
  requestSingle (const t_videoDataGroup &videoData,  downloadData &downData,
                  downloadedSegment &downSegment,  playbackDataGroup &playData, bufferDataGroup &bufferData,
                 mvdashAdaptationAlgorithm *pAlgorithm, MultiView_Model *pViewModel, std::string m_reqType);
